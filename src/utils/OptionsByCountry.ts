...
export const CountryCodes = [
  { value: '+93', short: 'AF', label: '+93 (Afghanistan)', icon: 'https://flagcdn.com/w20/af.png' },
  { value: '+355', short: 'AL', label: '+355 (Albania)', icon: 'https://flagcdn.com/w20/al.png' },
  { value: '+213', short: 'DZ', label: '+213 (Algeria)', icon: 'https://flagcdn.com/w20/dz.png' },
  { value: '+376', short: 'AD', label: '+376 (Andorra)', icon: 'https://flagcdn.com/w20/ad.png' },
  { value: '+244', short: 'AO', label: '+244 (Angola)', icon: 'https://flagcdn.com/w20/ao.png' },
  { value: '+1-264', short: 'AI', label: '+1-264 (Anguilla)', icon: 'https://flagcdn.com/w20/ai.png' },
  { value: '+1-268', short: 'AG', label: '+1-268 (Antigua & Barbuda)', icon: 'https://flagcdn.com/w20/ag.png' },
  { value: '+54', short: 'AR', label: '+54 (Argentina)', icon: 'https://flagcdn.com/w20/ar.png' },
  { value: '+374', short: 'AM', label: '+374 (Armenia)', icon: 'https://flagcdn.com/w20/am.png' },
  { value: '+61', short: 'AU', label: '+61 (Australia)', icon: 'https://flagcdn.com/w20/au.png' },
  { value: '+43', short: 'AT', label: '+43 (Austria)', icon: 'https://flagcdn.com/w20/at.png' },
  { value: '+32', short: 'BE', label: '+32 (Belgium)', icon: 'https://flagcdn.com/w20/be.png' },
  { value: '+387', short: 'BA', label: '+387 (Bosnia & Herzegovina)', icon: 'https://flagcdn.com/w20/ba.png' },
  { value: '+267', short: 'BW', label: '+267 (Botswana)', icon: 'https://flagcdn.com/w20/bw.png' },
  { value: '+359', short: 'BG', label: '+359 (Bulgaria)', icon: 'https://flagcdn.com/w20/bg.png' },
  { value: '+55', short: 'BR', label: '+55 (Brazil)', icon: 'https://flagcdn.com/w20/br.png' },
  { value: '+226', short: 'BF', label: '+226 (Burkina Faso)', icon: 'https://flagcdn.com/w20/bf.png' },
  { value: '+673', short: 'BN', label: '+673 (Brunei)', icon: 'https://flagcdn.com/w20/bn.png' },
  { value: '+57', short: 'CO', label: '+57 (Colombia)', icon: 'https://flagcdn.com/w20/co.png' },
  { value: '+243', short: 'CD', label: '+243 (Congo - Kinshasa)', icon: 'https://flagcdn.com/w20/cd.png' },
  { value: '+236', short: 'CF', label: '+236 (Central African Republic)', icon: 'https://flagcdn.com/w20/cf.png' },
  { value: '+385', short: 'HR', label: '+385 (Croatia)', icon: 'https://flagcdn.com/w20/hr.png' },
  { value: '+357', short: 'CY', label: '+357 (Cyprus)', icon: 'https://flagcdn.com/w20/cy.png' },
  { value: '+420', short: 'CZ', label: '+420 (Czech Republic)', icon: 'https://flagcdn.com/w20/cz.png' },
  { value: '+45', short: 'DK', label: '+45 (Denmark)', icon: 'https://flagcdn.com/w20/dk.png' },
  { value: '+253', short: 'DJ', label: '+253 (Djibouti)', icon: 'https://flagcdn.com/w20/dj.png' },
  { value: '+20', short: 'EG', label: '+20 (Egypt)', icon: 'https://flagcdn.com/w20/eg.png' },
  { value: '+503', short: 'SV', label: '+503 (El Salvador)', icon: 'https://flagcdn.com/w20/sv.png' },
  { value: '+372', short: 'EE', label: '+372 (Estonia)', icon: 'https://flagcdn.com/w20/ee.png' },
  { value: '+291', short: 'ER', label: '+291 (Eritrea)', icon: 'https://flagcdn.com/w20/er.png' },
  { value: '+251', short: 'ET', label: '+251 (Ethiopia)', icon: 'https://flagcdn.com/w20/et.png' },
  { value: '+358', short: 'FI', label: '+358 (Finland)', icon: 'https://flagcdn.com/w20/fi.png' },
  { value: '+33', short: 'FR', label: '+33 (France)', icon: 'https://flagcdn.com/w20/fr.png' },
  { value: '+241', short: 'GA', label: '+241 (Gabon)', icon: 'https://flagcdn.com/w20/ga.png' },
  { value: '+220', short: 'GM', label: '+220 (Gambia)', icon: 'https://flagcdn.com/w20/gm.png' },
  { value: '+995', short: 'GE', label: '+995 (Georgia)', icon: 'https://flagcdn.com/w20/ge.png' },
  { value: '+49', short: 'DE', label: '+49 (Germany)', icon: 'https://flagcdn.com/w20/de.png' },
  { value: '+233', short: 'GH', label: '+233 (Ghana)', icon: 'https://flagcdn.com/w20/gh.png' },
  { value: '+30', short: 'GR', label: '+30 (Greece)', icon: 'https://flagcdn.com/w20/gr.png' },
  { value: '+502', short: 'GT', label: '+502 (Guatemala)', icon: 'https://flagcdn.com/w20/gt.png' },
  { value: '+852', short: 'HK', label: '+852 (Hong Kong)', icon: 'https://flagcdn.com/w20/hk.png' },
  { value: '+504', short: 'HN', label: '+504 (Honduras)', icon: 'https://flagcdn.com/w20/hn.png' },
  { value: '+36', short: 'HU', label: '+36 (Hungary)', icon: 'https://flagcdn.com/w20/hu.png' },
  { value: '+354', short: 'IS', label: '+354 (Iceland)', icon: 'https://flagcdn.com/w20/is.png' },
  { value: '+91', short: 'IN', label: '+91 (India)', icon: 'https://flagcdn.com/w20/in.png' },
  { value: '+62', short: 'ID', label: '+62 (Indonesia)', icon: 'https://flagcdn.com/w20/id.png' },
  { value: '+98', short: 'IR', label: '+98 (Iran)', icon: 'https://flagcdn.com/w20/ir.png' },
  { value: '+964', short: 'IQ', label: '+964 (Iraq)', icon: 'https://flagcdn.com/w20/iq.png' },
  { value: '+353', short: 'IE', label: '+353 (Ireland)', icon: 'https://flagcdn.com/w20/ie.png' },
  { value: '+39', short: 'IT', label: '+39 (Italy)', icon: 'https://flagcdn.com/w20/it.png' },
  { value: '+81', short: 'JP', label: '+81 (Japan)', icon: 'https://flagcdn.com/w20/jp.png' },
  { value: '+962', short: 'JO', label: '+962 (Jordan)', icon: 'https://flagcdn.com/w20/jo.png' },
  { value: '+7', short: 'RU', label: '+7 (Kazakhstan / Russia)', icon: 'https://flagcdn.com/w20/ru.png' },
  { value: '+254', short: 'KE', label: '+254 (Kenya)', icon: 'https://flagcdn.com/w20/ke.png' },
  { value: '+965', short: 'KW', label: '+965 (Kuwait)', icon: 'https://flagcdn.com/w20/kw.png' },
  { value: '+856', short: 'LA', label: '+856 (Laos)', icon: 'https://flagcdn.com/w20/la.png' },
  { value: '+371', short: 'LV', label: '+371 (Latvia)', icon: 'https://flagcdn.com/w20/lv.png' },
  { value: '+423', short: 'LI', label: '+423 (Liechtenstein)', icon: 'https://flagcdn.com/w20/li.png' },
  { value: '+370', short: 'LT', label: '+370 (Lithuania)', icon: 'https://flagcdn.com/w20/lt.png' },
  { value: '+352', short: 'LU', label: '+352 (Luxembourg)', icon: 'https://flagcdn.com/w20/lu.png' },
  { value: '+853', short: 'MO', label: '+853 (Macau)', icon: 'https://flagcdn.com/w20/mo.png' },
  { value: '+60', short: 'MY', label: '+60 (Malaysia)', icon: 'https://flagcdn.com/w20/my.png' },
  { value: '+356', short: 'MT', label: '+356 (Malta)', icon: 'https://flagcdn.com/w20/mt.png' },
  { value: '+960', short: 'MV', label: '+960 (Maldives)', icon: 'https://flagcdn.com/w20/mv.png' },
  { value: '+223', short: 'ML', label: '+223 (Mali)', icon: 'https://flagcdn.com/w20/ml.png' },
  { value: '+212', short: 'MA', label: '+212 (Morocco)', icon: 'https://flagcdn.com/w20/ma.png' },
  { value: '+258', short: 'MZ', label: '+258 (Mozambique)', icon: 'https://flagcdn.com/w20/mz.png' },
  { value: '+95', short: 'MM', label: '+95 (Myanmar)', icon: 'https://flagcdn.com/w20/mm.png' },
  { value: '+264', short: 'NA', label: '+264 (Namibia)', icon: 'https://flagcdn.com/w20/na.png' },
  { value: '+977', short: 'NP', label: '+977 (Nepal)', icon: 'https://flagcdn.com/w20/np.png' },
  { value: '+31', short: 'NL', label: '+31 (Netherlands)', icon: 'https://flagcdn.com/w20/nl.png' },
  { value: '+687', short: 'NC', label: '+687 (New Caledonia)', icon: 'https://flagcdn.com/w20/nc.png' },
  { value: '+64', short: 'NZ', label: '+64 (New Zealand)', icon: 'https://flagcdn.com/w20/nz.png' },
  { value: '+505', short: 'NI', label: '+505 (Nicaragua)', icon: 'https://flagcdn.com/w20/ni.png' },
  { value: '+234', short: 'NG', label: '+234 (Nigeria)', icon: 'https://flagcdn.com/w20/ng.png' },
  { value: '+47', short: 'NO', label: '+47 (Norway)', icon: 'https://flagcdn.com/w20/no.png' },
  { value: '+968', short: 'OM', label: '+968 (Oman)', icon: 'https://flagcdn.com/w20/om.png' },
  { value: '+92', short: 'PK', label: '+92 (Pakistan)', icon: 'https://flagcdn.com/w20/pk.png' },
  { value: '+507', short: 'PA', label: '+507 (Panama)', icon: 'https://flagcdn.com/w20/pa.png' },
  { value: '+51', short: 'PE', label: '+51 (Peru)', icon: 'https://flagcdn.com/w20/pe.png' },
  { value: '+63', short: 'PH', label: '+63 (Philippines)', icon: 'https://flagcdn.com/w20/ph.png' },
  { value: '+48', short: 'PL', label: '+48 (Poland)', icon: 'https://flagcdn.com/w20/pl.png' },
  { value: '+351', short: 'PT', label: '+351 (Portugal)', icon: 'https://flagcdn.com/w20/pt.png' },
  { value: '+974', short: 'QA', label: '+974 (Qatar)', icon: 'https://flagcdn.com/w20/qa.png' },
  { value: '+40', short: 'RO', label: '+40 (Romania)', icon: 'https://flagcdn.com/w20/ro.png' },
  { value: '+7', short: 'RU', label: '+7 (Russia)', icon: 'https://flagcdn.com/w20/ru.png' },
  { value: '+250', short: 'RW', label: '+250 (Rwanda)', icon: 'https://flagcdn.com/w20/rw.png' },
  { value: '+966', short: 'SA', label: '+966 (Saudi Arabia)', icon: 'https://flagcdn.com/w20/sa.png' },
  { value: '+65', short: 'SG', label: '+65 (Singapore)', icon: 'https://flagcdn.com/w20/sg.png' },
  { value: '+421', short: 'SK', label: '+421 (Slovakia)', icon: 'https://flagcdn.com/w20/sk.png' },
  { value: '+386', short: 'SI', label: '+386 (Slovenia)', icon: 'https://flagcdn.com/w20/si.png' },
  { value: '+27', short: 'ZA', label: '+27 (South Africa)', icon: 'https://flagcdn.com/w20/za.png' },
  { value: '+82', short: 'KR', label: '+82 (South Korea)', icon: 'https://flagcdn.com/w20/kr.png' },
  { value: '+34', short: 'ES', label: '+34 (Spain)', icon: 'https://flagcdn.com/w20/es.png' },
  { value: '+46', short: 'SE', label: '+46 (Sweden)', icon: 'https://flagcdn.com/w20/se.png' },
  { value: '+41', short: 'CH', label: '+41 (Switzerland)', icon: 'https://flagcdn.com/w20/ch.png' },
  { value: '+886', short: 'TW', label: '+886 (Taiwan)', icon: 'https://flagcdn.com/w20/tw.png' },
  { value: '+66', short: 'TH', label: '+66 (Thailand)', icon: 'https://flagcdn.com/w20/th.png' },
  { value: '+216', short: 'TN', label: '+216 (Tunisia)', icon: 'https://flagcdn.com/w20/tn.png' },
  { value: '+90', short: 'TR', label: '+90 (Turkey)', icon: 'https://flagcdn.com/w20/tr.png' },
  { value: '+1', short: 'US', label: '+1 (United States)', icon: 'https://flagcdn.com/w20/us.png' },
  { value: '+44', short: 'UK', label: '+44 (United Kingdom)', icon: 'https://flagcdn.com/w20/gb.png' },
  { value: '+380', short: 'UA', label: '+380 (Ukraine)', icon: 'https://flagcdn.com/w20/ua.png' },
  { value: '+971', short: 'AE', label: '+971 (UAE)', icon: 'https://flagcdn.com/w20/ae.png' },
  { value: '+598', short: 'UY', label: '+598 (Uruguay)', icon: 'https://flagcdn.com/w20/uy.png' },
  { value: '+998', short: 'UZ', label: '+998 (Uzbekistan)', icon: 'https://flagcdn.com/w20/uz.png' },
  { value: '+1-787', short: 'PR', label: '+1-787 (Puerto Rico)', icon: 'https://flagcdn.com/w20/pr.png' },
  { value: '+58', short: 'VE', label: '+58 (Venezuela)', icon: 'https://flagcdn.com/w20/ve.png' },
  { value: '+84', short: 'VN', label: '+84 (Vietnam)', icon: 'https://flagcdn.com/w20/vn.png' },
  { value: '+681', short: 'WF', label: '+681 (Wallis & Futuna)', icon: 'https://flagcdn.com/w20/wf.png' },
  { value: '+212', short: 'EH', label: '+212 (Western Sahara)', icon: 'https://flagcdn.com/w20/eh.png' },
  { value: '+967', short: 'YE', label: '+967 (Yemen)', icon: 'https://flagcdn.com/w20/ye.png' },
  { value: '+260', short: 'ZM', label: '+260 (Zambia)', icon: 'https://flagcdn.com/w20/zm.png' },
  { value: '+263', short: 'ZW', label: '+263 (Zimbabwe)', icon: 'https://flagcdn.com/w20/zw.png' },
];
